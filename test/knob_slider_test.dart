...
void main() {
  group('KnobSlider Widget Tests', () {
    testWidgets('Should render initial value correctly', (WidgetTester tester) async {
    ...
    testWidgets('Should call onChanged when dragged', (WidgetTester tester) async {
      double? newValue;
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
      ...
      final TestGesture gesture = await tester.startGesture(center + const Offset(0, -60));
      await tester.pump();
    ...
    testWidgets('Should respect boundaries', (WidgetTester tester) async {
      ...
      final TestGesture gesture = await tester.startGesture(center + const Offset(60, 0)); // Right
      await tester.pump();
