...
void main() {
  ...
  group('MediaCollapsibleView Widget Tests', () {
    ...
    testWidgets('Should render initial state with media', (
      WidgetTester tester,
    ) async {
        ...
        MaterialApp(
          home: MediaCollapsibleView(
            ...
            mediaBuilder: (context) =>
                Container(color: Colors.red, key: const Key('media_content')),
          ),
        ),
      );
    ...
    testWidgets('Should expand comments sheet on chat button tap', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        MaterialApp(
    ...
    testWidgets('Should call onSendComment when submitting', (
      WidgetTester tester,
    ) async {
      String? sentComment;
      await tester.pumpWidget(
